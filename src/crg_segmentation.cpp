...
int main(int argc, char** argv)
{
  ...
  // transform the pointcloud, working copy will be called 'cloud'
  ...
  // Execute the transformation, new cloud is called cloud
  pcl::transformPointCloud (*cloud_input, *cloud, transform); 
  ...
  pcl::PassThrough<pcl::PointXYZRGB> pass; //cloud_input
