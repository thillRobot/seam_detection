...
void get_target_stateCallback(const std_msgs::Bool::ConstPtr& msg)
{
...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber get_target_state_sub = node.subscribe("/get_target/get_target_state", 1000, get_target_stateCallback);
